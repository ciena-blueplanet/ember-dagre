...
import sort from 'ciena-dagre/order/sort'
import {describe, it} from 'mocha'

describe('sort', function () {
  it('should sort nodes by barycenter', function () {
    const input = [
  ...
  it('should sort super-nodes', function () {
    const input = [
  ...
  it('should bias to the left by default', function () {
    const input = [
  ...
  it('should bias to the right if biasRight = true', function () {
    const input = [
      {vs: ['a'], i: 0, barycenter: 1, weight: 1},
      {vs: ['b'], i: 1, barycenter: 1, weight: 1}
    ]
  ...
  it('should sort nodes without a barycenter', function () {
    const input = [
  ...
  it('should handle no barycenters for any nodes', function () {
    const input = [
      {vs: ['a'], i: 0},
      {vs: ['b'], i: 3},
      {vs: ['c'], i: 2},
  ...
  it('should handle a barycenter of 0', function () {
    const input = [
